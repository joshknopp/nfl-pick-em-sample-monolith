...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("nflPickEmSampleApp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("nflPickEmSampleApp");
        ...
        config.getMapConfigs().put("io.github.jhipster.application.nflpickem.domain.*", initializeDomainMapConfig(jHipsterProperties));
